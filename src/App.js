...
// Change this line at the top of your App.js:
const API = process.env.REACT_APP_API_URL || "https://inventory-backend-production-272a.up.railway.app";
...
function App() {
  ...
  if (!user) {
    return <LoginScreen onLogin={handleLogin} toasts={toasts} />;
  }
